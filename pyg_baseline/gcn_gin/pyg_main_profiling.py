...
parser.add_argument("--epochs", type=int, default=2000, help="number of epoches")
...
parser.add_argument("--torch_profile", type=int, default=1,  help="torch_profile")
