...
parser.add_argument("--aggregator_type", type=str, default='add', choices=['add'], help="aggregator_type")
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = SAGEConv(dataset.num_features, args.hidden, root_weight = False,
                            normalize=False, aggr = args.aggregator_type)

        self.conv2 = SAGEConv(args.hidden, dataset.num_classes, root_weight = False,
                            normalize=False, aggr = args.aggregator_type)
    ...
    def forward(self):
        ...
        rst1 = self.conv1(x, adj_tensor, edge_weight)
        rst2 = self.conv2(rst1, adj_tensor, edge_weight)
